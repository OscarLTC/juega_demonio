        ...
        <div className="w-full max-w-md">
          <div className="bg-dark border border-charcoal/30 rounded-2xl p-8 text-center">
            ...
            <p className="text-dark-gray mb-6">
              Si existe una cuenta con el correo <strong className="text-gray">{email}</strong>, recibiras un enlace para restablecer tu contrasena.
            </p>
      ...
      <div className="w-full max-w-md">
        <div className="bg-dark border border-charcoal/30 rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-light-gray">Recuperar contrasena</h1>
            <p className="text-dark-gray mt-1">Te enviaremos un enlace para restablecerla</p>
          </div>
